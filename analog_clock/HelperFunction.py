...
def get_ticks():
    hours_init = []      # intial point or marker of hours
    hours_dest = []      # destination of point of hour 

    for i in range(0,360,6):                # looping over the 360 drgrees of clock
        x_coordinate = int(CENTER[0] + RADIUS * math.cos(i * math.pi / 180))     # x coordinates of x in the ticks 
...
def draw_time(image):
    ...
    time = getDigitalTimer(int(hour), minute, second)
